                            ...
                            <div class="card-body">
                                <div class="m-sm-4">
                                    <form id="validation-form"
                                        action="<?php echo base_url(); ?>index.php/auth/processresetpassword"
                                        method="post">
                                        <div class="form-group">
                                            <label>New password</label>
                                            <input class="form-control form-control-lg" type="password"
                                                autocomplete="off" name="validation-password"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control form-control-lg" type="password"
                                                autocomplete="off" name="validation-password-confirmation"

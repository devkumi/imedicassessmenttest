...
include(APPPATH . 'include/associate/header.php') ?>
...
<body>
    ...
    <div class="wrapper">
        ...
        <?php include(APPPATH . 'include/associate/sidebar.php') ?>
        ...
        <div class="main">
            ...
            <!-- navbar here -->
            <?php include(APPPATH . 'include/associate/navbar.php') ?>
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <?php
                            // print_r($viewreports);
                            include(APPPATH . 'include/associate/message.php') ?>
                            <div class="card">
                                    ...
                                    <?php
                                        ...
                                        foreach ($managefile as $key) {
                                            ...
                                            echo "
                                                ...
                                                include(APPPATH . 'include/associate/modals/preview-pdf.php');
                                        }
                                    ?>
                                </div>
        ...
        <div class="modal-dialog  modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body m-3">
                    <form action="<?php echo base_url(); ?>asaddfile" method="POST" enctype="multipart/form-data" id="uploadForm">
    ...
    <?php include(APPPATH . 'include/associate/footer.php') ?>
    ...
    <?php include(APPPATH . 'include/associate/scripts.php') ?>

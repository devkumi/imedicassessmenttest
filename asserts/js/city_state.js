...
city_states['Ghana'] = '|Accra|Aflao|Bawku|Berekum|Bolgatanga|Cape Coast|Dambai|Damongo|Diari|Goaso|Gumani|Ho|Hohoe|Kanvile|Keta|Koforidua|Kumasi|Nalerigu|Nkawkaw|Obuase|Sang|Sefwi Wiawso|Sekondi|Sunyani|Tamale|Techiman|Tema|Wa|Winneba|Yendi';
...
city_states['South Africa'] = '|Alberton|Alexander Bay|Aliwal North|Beaufort West|Benoni|Bethal|Bethlehem|Bhisho|Bloemfontein|Bloemhof|Brakpan|Brandfort|Bredasdorp|Brits|Bronkhorstspruit|Caledon|Cape Town|Carletonville|Carnarvon|Centurion|Citrusdal|Clanwilliam|Colesberg|Cradock|Darling|De Aar|Durban|East London|Genadendal|George|Graaff-Reinet|Grahamstown|Hermanus|Hopefield|Jeffreyâ€™s Bay|Johannesburg|Kimberley|Klawer|Kleinmond|Klerksdorp|Knysna|Komatipoort|Kroonstad|Kuilsrivier|Kuruman|Ladysmith|Lambertâ€™s Bay|Lebowakgomo|Lichtenburg|Mahikeng|Malmesbury|Middelburg|Middelburg|Mmabatho|Montagu|Moorreesburg|Mossel Bay|Musina|Nelspruit|Onrus|Oudtshoorn|Paarl|Phalaborwa|Pietermaritzburg|Piketberg|Pofadder|Polokwane|Port Alfred|Port Elizabeth|Port Saint Johnâs|Port Shepstone|Porterville|Potchefstroom|Pretoria|Prieska|Queenstown|Randburg|Riviersonderend|Robertson|Roodepoort|Rustenburg|Saint Helena Bay|Saldanha|Sandton|Saron|Soweto|Springbok|Springs|Standerton|Swellendam|Thohoyandou|Tulbagh|Tzaneen|Ubombo|Uitenhage|Ulundi|Umtata|Upington|Vanderbijlpark|Vanrhynsdorp|Velddrif|Vereeniging|Villiersdorp|Volksrust|Vredenburg|Vryburg|Vryheid|Welkom|Worcester|Grytviken';
...
city_states['Germany'] = '|Berlin|Frankfurt|Baden-Wuerttemberg|Bayern|Berlin|Brandenburg|Bremen|Hamburg|Hessen|Munich|Dusseldorf|Mecklenburg-Vorpommern|Niedersachsen|Nordrhein-Westfalen|Rheinland-Pfalz|Saarland|Sachsen|Sachsen-Anhalt|Schleswig-Holstein|Thueringen';
...
city_states['Italy'] = '|Rome|Abruzzi|Basilicata|Milan|Calabria|Campania|Emilia-Romagna|Friuli-Venezia Giulia|Lazio|Liguria|Lombardia|Marche|Molise|Piemonte|Puglia|Sardegna|Sicilia|Toscana|Trentino-Alto Adige|Umbria|Valle d\'Aosta|Veneto';
...
city_states['Switzerland'] = '|Bern|Geneva|Aargau|Appenzell Ausser-Rhoden|Appenzell Inner-Rhoden|Basel-Landschaft|Basel-Stadt|Fribourg|Geneve|Glarus|Graubunden|Jura|Luzern|Neuchatel|Nidwalden|Obwalden|Sankt Gallen|Schaffhausen|Schwyz|Solothurn|Thurgau|Ticino|Uri|Valais|Vaud|Zug|Zurich';
